...
func (x *GreetSumRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetSumRequest) ProtoMessage() {}

func (x *GreetSumRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greet_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetSumRequest.ProtoReflect.Descriptor instead.
func (*GreetSumRequest) Descriptor() ([]byte, []int) {
	return file_greet_proto_rawDescGZIP(), []int{2}
}

func (x *GreetSumRequest) GetNumber1() int32 {
	if x != nil {
		return x.Number1
	}
	return 0
...
func (x *GreetSumRequest) GetNumber2() int32 {
	if x != nil {
		return x.Number2
	}
	return 0
...
func (x *GreetSumResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GreetSumResponse) ProtoMessage() {}

func (x *GreetSumResponse) ProtoReflect() protoreflect.Message {
	mi := &file_greet_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GreetSumResponse.ProtoReflect.Descriptor instead.
func (*GreetSumResponse) Descriptor() ([]byte, []int) {
	return file_greet_proto_rawDescGZIP(), []int{3}
}

func (x *GreetSumResponse) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
var file_greet_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x45, 0x0a, 0x0f,
	0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x65, 0x72, 0x32, 0x22, 0x2a, 0x0a, 0x10, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x75, 0x6d, 0x52,
	...
	0x6e, 0x73, 0x65, 0x32, 0x4e, 0x0a, 0x0f, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x75, 0x6d, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53,
	0x75, 0x6d, 0x12, 0x16, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74,
	0x53, 0x75, 0x6d, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x67, 0x72, 0x65,
	0x65, 0x74, 0x2e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x42, 0x1e, 0x5a, 0x1c, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x75, 0x64, 0x65, 0x6d, 0x79, 0x2f, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2f, 0x70, 0x72,
...
var file_greet_proto_goTypes = []interface{}{
	...
	(*GreetSumRequest)(nil),  // 2: greet.GreetSumRequest
	(*GreetSumResponse)(nil), // 3: greet.GreetSumResponse
}
var file_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetService.Greet:input_type -> greet.GreetRequest
	2, // 1: greet.GreetSumService.GreetSum:input_type -> greet.GreetSumRequest
	1, // 2: greet.GreetService.Greet:output_type -> greet.GreetResponse
	3, // 3: greet.GreetSumService.GreetSum:output_type -> greet.GreetSumResponse
